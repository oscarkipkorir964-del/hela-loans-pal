      ...
      <div className="container max-w-3xl mx-auto">
        <Card className="shadow-card">
          <CardHeader className="text-center">
            <img src={okoaPesaLogo} alt="Okoa Pesa" className="w-16 h-16 object-contain mx-auto mb-4" />
            <CardTitle className="text-2xl">Terms & Conditions</CardTitle>
            <CardDescription>
              Okoa Pesa Service Agreement
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="bg-muted p-6 rounded-xl max-h-[70vh] overflow-y-auto space-y-6 text-sm">
              ...
              <div className="text-center border-b border-border pb-4">
                <img src={okoaPesaLogo} alt="Okoa Pesa" className="w-12 h-12 object-contain mx-auto mb-3" />
                <h3 className="font-bold text-lg">Okoa Pesa</h3>
                <p className="text-muted-foreground">P.O BOX 30834-0100, NAIROBI, KENYA</p>
              </div>

              <div className="space-y-2">
                <h3 className="font-bold text-lg">TERMS AND CONDITIONS OF LOANS – Okoa Pesa Kenya</h3>
                <p className="text-muted-foreground">
                  Terms and Conditions for the Opening and Use of a Loan Account with Okoa Pesa, Kenya.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  This Agreement is a financial service and an end-user licence agreement between you ("End-user" or "you" or "Borrower") and Okoa Pesa, a company incorporated under the laws of the Republic of Kenya (hereinafter called "Okoa Pesa" or "Lender" or "us" or "we").
                </p>
                <p className="text-muted-foreground">
                  This Agreement (together with our Privacy Policy) sets out the complete terms and conditions (the "Terms and Conditions") which shall be applicable to the Account opened by you with Okoa Pesa.
                </p>
                <p className="text-muted-foreground">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4">
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                    ...
                    <li><strong>Account</strong> means your loan account with Okoa Pesa;</li>
                    ...
                    <li><strong>Loan</strong> means the principal amount of the loan made by Okoa Pesa to you under this Agreement;</li>
                    ...
                    <li><strong>Privacy Policy</strong> means the Okoa Pesa privacy policy;</li>
                    <li><strong>Request</strong> means a request or instruction received by Okoa Pesa from you through the System;</li>
                    <li><strong>Services</strong> shall include any form of financial services that Okoa Pesa may offer you;</li>
                    ...
                    <li><strong>System</strong> means Okoa Pesa's electronic communications software;</li>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>2.1 You must carefully read and understand these Terms and Conditions before downloading the App or opening an account with Okoa Pesa.</p>
                  ...
                  <p>2.4 These Terms and Conditions may be amended by Okoa Pesa from time to time. Continued use constitutes your agreement to any amendments.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>Okoa Pesa reserves the right to verify the authenticity of your Mobile Money Account;</li>
                    <li>Okoa Pesa reserves the right to decline your application at its sole discretion;</li>
                    <li>Okoa Pesa determines your maximum loan eligibility based on established assessment procedures;</li>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>You authorize Okoa Pesa to verify information provided against Mobile Money Provider records;</li>
                    <li>Information verified includes phone number, name, date of birth, ID/Passport Number;</li>
                    <li>You authorize Okoa Pesa to access data from your Equipment and SMS messages;</li>
                    <li>You consent to Okoa Pesa obtaining your Personal Information from Mobile Money Providers;</li>
                    <li>You authorize Okoa Pesa to access and query your credit information from licensed CRBs;</li>
                    <li>Okoa Pesa may request further information at any time. Failure to provide may result in declined applications.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>6.1 You irrevocably authorize Okoa Pesa to act on all Requests received from you through the System.</p>
                  <p>6.2 Okoa Pesa reserves the right to reject any Request at its discretion.</p>
                  <p>6.3 Okoa Pesa may act upon incomplete or ambiguous Requests if it believes it can correct the information.</p>
                  <p>6.4 Okoa Pesa shall be deemed to have acted properly even if the Request was sent in error or fraudulently.</p>
                  <p>6.5 Okoa Pesa may decline to act on any Request pending further enquiry.</p>
                  <p>6.6 You agree to indemnify Okoa Pesa against all claims arising from acting on your Requests.</p>
                  <p>6.7 Okoa Pesa shall not be liable for any unauthorized activity on your Account.</p>
                  <p>6.8 Okoa Pesa is authorized to comply with court orders or competent authority requirements.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>7.2 The interest payable shall be displayed on the App. Okoa Pesa may charge Transaction Fees which are subject to change.</p>
                  ...
                  <p>7.5 Okoa Pesa may approve loan extension requests subject to payment of accrued interest.</p>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>Email: support@okoapesa.co.ke</li>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>8.3 You must check your statement carefully and notify Okoa Pesa of any discrepancies.</p>
                  <p>8.4 Okoa Pesa reserves the right to rectify discrepancies without prior notice.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>9.2 You consent to Okoa Pesa withholding amounts if required by any tax authority.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>10.3 You shall follow all instructions and procedures provided by Okoa Pesa.</p>
                  ...
                  <p>10.6 You shall follow the security procedures notified by Okoa Pesa.</p>
                  <p>10.7 You shall not operate the Services in any manner prejudicial to Okoa Pesa.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>11.2 After an Event of Default, Okoa Pesa may:</p>
                  <ul className="list-disc pl-6 space-y-1">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>12.1 Okoa Pesa may terminate its relationship with you and close your Account at any time.</p>
                  <p>12.2 Okoa Pesa may suspend or close your Account if:</p>
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>Okoa Pesa decides to suspend Services for commercial reasons.</li>
                  </ul>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>13.1 Okoa Pesa shall not be responsible for any loss due to failure of your Equipment, Force Majeure, or circumstances beyond our control.</p>
                  ...
                  <p>13.4 Okoa Pesa will not be liable for losses resulting from:</p>
                  <ul className="list-disc pl-6 space-y-1">
                  ...
                  <p>13.5 Under no circumstances shall Okoa Pesa be liable for any loss of profit or indirect/consequential loss.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>14.1 You undertake to indemnify Okoa Pesa against any loss, charge, damage, expense or claim which Okoa Pesa suffers from acting on your instructions.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>15.1 You can contact us by email at support@okoapesa.co.ke.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>No failure by Okoa Pesa to exercise any right shall operate as a waiver of such right.</p>
              ...
              <div className="mt-6 p-4 bg-primary/10 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  ...
                  Email: support@okoapesa.co.ke<br />
