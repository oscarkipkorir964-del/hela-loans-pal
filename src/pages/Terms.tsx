      ...
      <div className="container max-w-3xl mx-auto">
        <Card className="shadow-card">
          <CardHeader className="text-center">
            <img src={mwananchiLogo} alt="Mwananchi Credit Loans" className="w-16 h-16 object-contain mx-auto mb-4" />
            <CardTitle className="text-2xl">Terms & Conditions</CardTitle>
            <CardDescription>
              Mwananchi Credit Loans Service Agreement
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="bg-muted p-6 rounded-xl max-h-[70vh] overflow-y-auto space-y-6 text-sm">
              ...
              <div className="text-center border-b border-border pb-4">
                <img src={mwananchiLogo} alt="Mwananchi Credit Loans" className="w-12 h-12 object-contain mx-auto mb-3" />
                <h3 className="font-bold text-lg">Mwananchi Credit Loans</h3>
                <p className="text-muted-foreground">P.O BOX 30834-0100, NAIROBI, KENYA</p>
              </div>

              <div className="space-y-2">
                <h3 className="font-bold text-lg">TERMS AND CONDITIONS OF LOANS – Mwananchi Credit Loans Kenya</h3>
                <p className="text-muted-foreground">
                  Terms and Conditions for the Opening and Use of a Loan Account with Mwananchi Credit Loans, Kenya.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  This Agreement is a financial service and an end-user licence agreement between you ("End-user" or "you" or "Borrower") and Mwananchi Credit Loans, a company incorporated under the laws of the Republic of Kenya (hereinafter called "Mwananchi Credit Loans" or "Lender" or "us" or "we").
                </p>
                <p className="text-muted-foreground">
                  This Agreement (together with our Privacy Policy) sets out the complete terms and conditions (the "Terms and Conditions") which shall be applicable to the Account opened by you with Mwananchi Credit Loans.
                </p>
                <p className="text-muted-foreground">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4">
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                    ...
                    <li><strong>Account</strong> means your loan account with Mwananchi Credit Loans;</li>
                    ...
                    <li><strong>Loan</strong> means the principal amount of the loan made by Mwananchi Credit Loans to you under this Agreement;</li>
                    ...
                    <li><strong>Privacy Policy</strong> means the Mwananchi Credit Loans privacy policy;</li>
                    <li><strong>Request</strong> means a request or instruction received by Mwananchi Credit Loans from you through the System;</li>
                    <li><strong>Services</strong> shall include any form of financial services that Mwananchi Credit Loans may offer you;</li>
                    ...
                    <li><strong>System</strong> means Mwananchi Credit Loans's electronic communications software;</li>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>2.1 You must carefully read and understand these Terms and Conditions before downloading the App or opening an account with Mwananchi Credit Loans.</p>
                  ...
                  <p>2.4 These Terms and Conditions may be amended by Mwananchi Credit Loans from time to time. Continued use constitutes your agreement to any amendments.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>Mwananchi Credit Loans reserves the right to verify the authenticity of your Mobile Money Account;</li>
                    <li>Mwananchi Credit Loans reserves the right to decline your application at its sole discretion;</li>
                    <li>Mwananchi Credit Loans determines your maximum loan eligibility based on established assessment procedures;</li>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>You authorize Mwananchi Credit Loans to verify information provided against Mobile Money Provider records;</li>
                    <li>Information verified includes phone number, name, date of birth, ID/Passport Number;</li>
                    <li>You authorize Mwananchi Credit Loans to access data from your Equipment and SMS messages;</li>
                    <li>You consent to Mwananchi Credit Loans obtaining your Personal Information from Mobile Money Providers;</li>
                    <li>You authorize Mwananchi Credit Loans to access and query your credit information from licensed CRBs;</li>
                    <li>Mwananchi Credit Loans may request further information at any time. Failure to provide may result in declined applications.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>6.1 You irrevocably authorize Mwananchi Credit Loans to act on all Requests received from you through the System.</p>
                  <p>6.2 Mwananchi Credit Loans reserves the right to reject any Request at its discretion.</p>
                  <p>6.3 Mwananchi Credit Loans may act upon incomplete or ambiguous Requests if it believes it can correct the information.</p>
                  <p>6.4 Mwananchi Credit Loans shall be deemed to have acted properly even if the Request was sent in error or fraudulently.</p>
                  <p>6.5 Mwananchi Credit Loans may decline to act on any Request pending further enquiry.</p>
                  <p>6.6 You agree to indemnify Mwananchi Credit Loans against all claims arising from acting on your Requests.</p>
                  <p>6.7 Mwananchi Credit Loans shall not be liable for any unauthorized activity on your Account.</p>
                  <p>6.8 Mwananchi Credit Loans is authorized to comply with court orders or competent authority requirements.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>7.2 The interest payable shall be displayed on the App. Mwananchi Credit Loans may charge Transaction Fees which are subject to change.</p>
                  ...
                  <p>7.5 Mwananchi Credit Loans may approve loan extension requests subject to payment of accrued interest.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>8.3 You must check your statement carefully and notify Mwananchi Credit Loans of any discrepancies.</p>
                  <p>8.4 Mwananchi Credit Loans reserves the right to rectify discrepancies without prior notice.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>9.2 You consent to Mwananchi Credit Loans withholding amounts if required by any tax authority.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>10.3 You shall follow all instructions and procedures provided by Mwananchi Credit Loans.</p>
                  ...
                  <p>10.6 You shall follow the security procedures notified by Mwananchi Credit Loans.</p>
                  <p>10.7 You shall not operate the Services in any manner prejudicial to Mwananchi Credit Loans.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>11.2 After an Event of Default, Mwananchi Credit Loans may:</p>
                  <ul className="list-disc pl-6 space-y-1">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>12.1 Mwananchi Credit Loans may terminate its relationship with you and close your Account at any time.</p>
                  <p>12.2 Mwananchi Credit Loans may suspend or close your Account if:</p>
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>Mwananchi Credit Loans decides to suspend Services for commercial reasons.</li>
                  </ul>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>13.1 Mwananchi Credit Loans shall not be responsible for any loss due to failure of your Equipment, Force Majeure, or circumstances beyond our control.</p>
                  ...
                  <p>13.4 Mwananchi Credit Loans will not be liable for losses resulting from:</p>
                  <ul className="list-disc pl-6 space-y-1">
                  ...
                  <p>13.5 Under no circumstances shall Mwananchi Credit Loans be liable for any loss of profit or indirect/consequential loss.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  <p>14.1 You undertake to indemnify Mwananchi Credit Loans against any loss, charge, damage, expense or claim which Mwananchi Credit Loans suffers from acting on your instructions.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 pl-4 text-muted-foreground">
                  ...
                  <p>No failure by Mwananchi Credit Loans to exercise any right shall operate as a waiver of such right.</p>
