    ...
    <main className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 text-center">
          <img src={okoaPesaLogo} alt="Okoa Pesa" className="w-16 h-16 object-contain mx-auto mb-3" />
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground/90">
          <section>
            ...
            <p>When you use Okoa Pesa, we collect the following information:</p>
          ...
          <section>
            ...
            <p>Okoa Pesa is not intended for users under 18 years of age. We do not knowingly collect information from children under 18.</p>
          </section>
