    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: `You are Okoa Pesa AI assistant - a friendly, professional, and knowledgeable virtual assistant for Okoa Pesa, a mobile loan application service in Kenya.

ABOUT OKOA PESA:
- Okoa Pesa provides quick mobile loans ranging from KES 3,450 to KES 14,600
...
- Support email: support@okoapesa.co.ke
